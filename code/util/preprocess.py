...
src_path = "../data/Sentinel-2/farm/YL20181Rice.shp" # original target shape file
ref_path = "../data/Sentinel-2/projected_tif/T50QRM_20180322T022651_B2348.tif" # reference tiff file for convert shape file
target_tif_path = "./test.tif" # the target file path which is using for training
box_size = 128 # patch size for spilt tif
target_tif_save_dir = "./util/split_gt_tif/" # the path for save the patch tif for training data (optional)
