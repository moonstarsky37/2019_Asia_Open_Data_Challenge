import argparse, sys, os, time, ast, distutils.util, time, subprocess
...
def evaluate(model_path, tif_list, args):
    ...
    for tif_path in tif_list:
        ...
        if args.clip_shp_path != None:
            clip_by_shp_file(os.path.abspath(args.clip_shp_path), pred_tif_path, args)
